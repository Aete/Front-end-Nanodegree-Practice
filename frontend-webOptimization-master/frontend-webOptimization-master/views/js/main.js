...
var resizePizzas = function(size) {
  ...
  function changePizzaSizes(size) {
    ...
    var ramdomPizzas = document.getElementsByClassName("randomPizzaContainer");   // change queryselectorall  to getElementsByClassName
...
// I move var pizzasDIV above the for loop
...
// I change this by moving calculation of scrolltop outside of 'for' loop
// I change
function updatePositions() {
  frame++;
  window.performance.mark("mark_start_frame");
    var items = document.getElementsByClassName('mover');  //change queryselectorAll to getElementsByClassName
    var storedScrollTop = document.documentElement.scrollTop;
...
// Calculate the row number of pizzas of background
document.addEventListener('DOMContentLoaded', function() {
  var rows = Math.floor(window.innerHeight / 200);
  var cols = 8;
  var s =256;
  var movingPizzas = document.getElementById('movingPizzas1'); // adding this var by using getElementByid
